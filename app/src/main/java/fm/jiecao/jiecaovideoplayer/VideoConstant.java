...
public class VideoConstant {
    ...
    public static List<VideoBean> getDataList(){
        ...
        for (int i = 0; i < 5; i++) {
            list.add(new VideoBean("http://video.jiecao.fm/8/17/bGQS3BQQWUYrlzP1K4Tg4Q__.mp4",
                    "http://img4.jiecaojingxuan.com/2016/8/17/bd7ffc84-8407-4037-a078-7d922ce0fb0f.jpg",
                    "两个小智障1"));
            list.add(new VideoBean("http://video.jiecao.fm/8/17/%E6%8A%AB%E8%90%A8.mp4",
                    "http://img4.jiecaojingxuan.com/2016/8/17/f2dbd12e-b1cb-4daf-aff1-8c6be2f64d1a.jpg",
                    "两个小智障2"));

            list.add(new VideoBean("http://video.jiecao.fm/8/18/%E5%A4%A7%E5%AD%A6.mp4",
                    "http://img4.jiecaojingxuan.com/2016/8/18/ccd86ca1-66c7-4331-9450-a3b7f765424a.png",
                    "两个小智障3"));
            list.add(new VideoBean("http://video.jiecao.fm/8/16/%E8%B7%B3%E8%88%9E.mp4",
                    "http://img4.jiecaojingxuan.com/2016/8/16/2adde364-9be1-4864-b4b9-0b0bcc81ef2e.jpg",
                    "两个小智障4"));
            list.add(new VideoBean("http://video.jiecao.fm/11/24/xin/-%2024%20-%20.mp4",
